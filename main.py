...
def handle_message(message):
    ...
    if chat_id not in user_data:
        ...
        # Сохраняем имя файла и создаём пустой буфер для содержимого
        user_data[chat_id] = {
            "file_name": text,
            "content": ""
        }
    ...
    # Если пользователь написал "Готово" или "/end" — сохраняем и отправляем файл
